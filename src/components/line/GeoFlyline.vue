...
<template>
  ...
  >
    <GeoTubeline
      ...
      @doubleclick="(...args) => emit('doubleclick', ...args)"
      @contextmenu="(...args) => emit('contextmenu', ...args)"
      @pointerenter="(...args) => emit('pointerenter', ...args)"
      @pointerleave="(...args) => emit('pointerleave', ...args)"
      @pointerover="(...args) => emit('pointerover', ...args)"
      @pointerdown="(...args) => emit('pointerdown', ...args)"
      @pointerup="(...args) => emit('pointerup', ...args)"
