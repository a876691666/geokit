<template>
  <div class="overlay">
    ...
    <div class="control-panel">
      ...
      <button class="control-btn" @click="position = { ...position, pitch: position.pitch + 10 }">
        俯仰 + 10°
      </button>
      <button class="control-btn" @click="position = { ...position, pitch: position.pitch - 10 }">
        俯仰 - 10°
      ...
      <button
        class="control-btn"
        @click="position = { ...position, longitude: position.longitude + 0.001 }"
      >
        经度 + 0.001°
      </button>
      <button
      ...
      <button
        class="control-btn"
        @click="position = { ...position, latitude: position.latitude + 0.001 }"
      >
        纬度 + 0.001°
      </button>
      <button
